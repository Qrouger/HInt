...
conda activate HInt
pip install HInt torchdata==0.9.0 pandas pydantic packaging opt_einsum torch-geometric matplotlib nvidia-ml-py numpy==1.21.2 scipy==1.7.1 pip install einops nvidia-ml-py && \
